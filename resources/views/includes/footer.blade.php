        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 mb-5 mb-lg-0">
                    <img src="{{ url('assets/images/logo-laracuss-blue.png') }}" alt="Laracuss Logo" class="h-32px mb-4">
                    ...
                    <div class="d-flex flex-column flex-lg-row justify-content-end">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="text-white"><a href="{{ route('discussions.index') }}">Discussions</a></li>
                                <li class="text-white"><a href="{{ route('about-us') }}">About Us</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
