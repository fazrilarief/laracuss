...
class AnswerController extends Controller
{
    ...
    public function store(StoreRequest $request, $slug)
    {
        ...
        if ($create) {
            session()->flash('notif_success', 'Your answer posted successfully');
    ...
    public function update(UpdateRequest $request, string $id)
    {
        ...
        if ($update) {
            session()->flash('notif_success', 'Answer updated successfully!');
    ...
    public function destroy(string $id)
    {
        ...
        if ($delete) {
            session()->flash('notif_success', 'Answer deleted successfully!');
            return redirect()->route('discussions.show', $answer->discussion->slug);
        }
